// Write your JavaScript code here!
    ...
    const planetSelect = document.getElementById("planets");
        ...
        option.textContent = planets[0];
        option.value = planets[0];
 ...
 const results= calculateWeight(userWeight, planetName);

// //         // 6. Write code to display the message shown in the screenshot. 
 const output = document.getElementById("output");
 output.textContent = "If you were on " + planetName + ", "  + "you would weigh " + results.toFixed(2) + "lbs!"; 
     }  
